...
clear L
%            theta    d        a    alpha
% L(1) = Link([ pi/2    0        0     pi/2   0], 'modified');
% L(2) = Link([ pi/2    0        0    -pi/2   0], 'modified');
% L(3) = Link([-pi/2    0        0.5  -pi/2   0], 'modified');
% L(4) = Link([ pi/2    0        0     pi/2   0], 'modified');
% L(5) = Link([  0      0.5      0      0     0], 'modified');

% L(1) = Link([ 0    0        0     pi/2   0], 'modified');
% L(2) = Link([ 0    0        0    -pi/2   0], 'modified');
% L(3) = Link([ 0    0        0.5  -pi/2   0], 'modified');
...
L(3) = Revolute('d', 0, 'a', 0.5, 'alpha', -pi/2);

L(4) = Revolute('d', 0, 'a', 0, 'alpha', pi/2);

L(5) = Revolute('d', 0.5, 'a', 0, 'alpha', 0);
...
legm = SerialLink(L, 'name', 'Human_leg');
clear L
