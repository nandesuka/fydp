...
*/    
    ...
    */
    ...
    if (stateOff >= stateLeft) {
      if (stateOff >= stateRight) {
        state = 0;
      } else {
        state = 1;
      }
...
#ifdef CONTROL_DEBUG
    Serial.print(stateLeft); Serial.print(", "); Serial.print(stateOff); Serial.print(", "); Serial.print(stateRight); Serial.print(", ");
