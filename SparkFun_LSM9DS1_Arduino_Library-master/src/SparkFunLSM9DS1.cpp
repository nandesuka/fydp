...
void LSM9DS1::getMotion9(float *accx, float *accy, float *accz, 
	...
	*gyrx = gRes * gx * (M_PI/180.0);
	*gyry = gRes * gy * (M_PI/180.0);
	*gyrz = gRes * gz * (M_PI/180.0);
...
// is good practice.
void LSM9DS1::calibrate(bool autoCalc, int sens)
{  
	if (autoCalc) {
